...
import { GetTimelineDto } from "../../../src/domain/dtos/GetTimelineDto";
...
describe("WeatherUseCases", () => {
    ...
    describe("getTimeline", () => {
        ...
        it("should return a timeline from a given location", async () => {
            ...
            jest.spyOn(service, "getTimeline").mockResolvedValueOnce(timeline);
            const result = await useCases.getTimeline(dto);
